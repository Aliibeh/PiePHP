...
<h1 class="title2">Ajoutez un genre.</h1>

<form method="POST" action="add3" class="d-flex justify-content-center">
	<div>
		<input type="text" name="nomg" class="form-control" placeholder="Nom du genre">
